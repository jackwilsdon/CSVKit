#
#  Be sure to run `pod spec lint CSVKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Jack Wilsdon"
  # s.authors            = { "Jack Wilsdon" => "jack.wilsdon@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Jack Wilsdon"
  ...
  s.source       = { :git => "https://github.com/jackwilsdon/CSVKit.git", :tag => "0.1.0" }
